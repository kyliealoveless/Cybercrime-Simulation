...
class Person {
    ...
    private:
        ...
        double digital_literacy; // this variable will represent the individual's digital literacy level.
        double online_exposure; // this variable will represent the individual's level of online exposure
        double scam_susceptibility; // this variable will represent the individual's susceptibility to scams.
        double risk_score; // this variable will represent the individual's overall risk score for being targeted by cybercrime.
        int exposure_count; // the higher their online exposure and therefore the higher their risk score.

    public:
        Person();
        Person(int id, string role);
        double calculateRiskScore(); // this will calculate the individual's risk score based on their digital literacy, online exposure, and scam susceptibility. The formula for this can be adjusted based on research findings, but for this example, I will use a simple weighted average.
